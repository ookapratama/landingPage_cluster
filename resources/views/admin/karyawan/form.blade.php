                        ...
                        <form id="kt_modal_new_target_form" class="form" action="#">
                            ...
                            <div class="row g-9 mb-8">
                                ...
                                <div class="col-md-6 fv-row">
                                    ...
                                    <input type="text" class="form-control" placeholder="Name" name="nama_cluster"
                                        id="nama_cluster" value="{{ $data->nama_cluster ?? '' }}" />
                                </div>

                                <div class="col-md-6 fv-row">
                                    <label class="required fs-6 fw-semibold mb-2">Custody</label>
                                    <input type="text" class="form-control" placeholder="Custody" name="custody"
                                        id="custody" value="{{ $data->custody ?? '' }}" />
                                </div>

                                <div class="col-md-6 fv-row">
                                    <label class="required fs-6 fw-semibold mb-2">Driver</label>
                                    <input type="text" class="form-control" placeholder="Driver" name="driver"
                                        id="driver" value="{{ $data->driver ?? '' }}" />
                                </div>
